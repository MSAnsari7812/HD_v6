<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="rptAdvanceReportViwer.aspx.cs" Inherits="Admin_rptComplainFormViewer" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="AccountContentPlaceHolder" Runat="Server">
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="1200px" Height="811px">
        <LocalReport ReportPath="Reports\rptAdvanceReport.rdlc">
        </LocalReport>
    </rsweb:ReportViewer>
           </div>
       </div>
